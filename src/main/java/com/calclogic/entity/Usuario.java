 ...
 *
 * <p>This table has all the users who have registered in the system, including their logins,
 * encrypted passwords and a boolean that indicates if the user activated the "automatic
 * substitution".
 */
@Entity
